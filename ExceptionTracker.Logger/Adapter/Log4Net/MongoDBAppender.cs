...
namespace ExceptionTracker.Logger.Adapter.Log4Net
{
    ...
    public class MongoDBAppender : AppenderSkeleton, IMongoDBAdapter<LoggingEvent>
    {
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        ...
        BsonDocument IMongoDBAdapter<LoggingEvent>.CreateBsonDocument(LoggingEvent logEvent)
        {
